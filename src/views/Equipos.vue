...
export default {
  ...
  methods: {
    generearUser() {
      if (this.equipoDetalle.mtr1 && this.equipoDetalle.mtr2) {
        return this.generarAleatorio();
      }
    },
    generarAleatorio() {
      var abc = "ABCDEFGHIJKLMNOPQRSTUVWYZabcdefghijklmnopqrstuvwxyz";
      if (this.equipoDetalle.mtr3 == null) {
        return (
          this.equipoDetalle.mtr1.slice(2, 4) +
          abc[Math.floor(Math.random() * 50)] +
          abc[Math.floor(Math.random() * 50)] +
          this.equipoDetalle.mtr2[2] +
          this.equipoDetalle.mtr2[7] +
          abc[Math.floor(Math.random() * 50)] +
          abc[Math.floor(Math.random() * 50)]
        );
      } else {
        return (
          ...
          abc[Math.floor(Math.random() * 50)] +
          abc[Math.floor(Math.random() * 50)] +
          this.equipoDetalle.mtr3.slice(6, 8) +
          abc[Math.floor(Math.random() * 50)] +
          abc[Math.floor(Math.random() * 50)]
        );
      }
    ...
    registrarEquipo(e) {
      e.preventDefault();
      this.equipoDetalle.codigo = this.generearUser();
